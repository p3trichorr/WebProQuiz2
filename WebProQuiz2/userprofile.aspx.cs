    ...
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_master_tbl set full_name=@full_name, dob=@dob, contact_no=@contact_no, email=@email, province=@province, city=@city, zipcode=@zipcode, full_address=@full_address, password=@password, account_status=@account_status WHERE member_id='" + Session["username"].ToString().Trim() + "'", con);
